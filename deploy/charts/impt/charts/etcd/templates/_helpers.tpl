...
{{- if .Values.volumePermissions.image.registry -}}{{ printf "%s/%s/%s" .Values.volumePermissions.image.registry .Values.volumePermissions.image.repository .Values.volumePermissions.image.name }}{{- else -}}{{- .Values.volumePermissions.image.repository -}}{{- end -}}
{{- end -}}
