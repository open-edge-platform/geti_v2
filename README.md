...
| |
|---|
| **🥁 Geti™ is growing up: lighter, unified, and built for the edge** <br><br> [Geti™ 3.0](https://github.com/open-edge-platform/geti) is a major release that streamlines the experience from installation to deployment, introduces several new capabilities, and radically simplifies the architecture. Geti™ is now significantly lighter - no longer dependent on Kubernetes as the default architecture, it can now run directly on edge and client hardware with a fraction of the resources previously required, while remaining fully compatible with cloud and cluster-based infrastructure. <br><br> The application and its training backend now share a single repository, developed and maintained together as one cohesive project. <br><br> All future development continues in the **[Geti repository](https://github.com/open-edge-platform/geti)**. That is where new features, improvements, and community contributions happen. We hope to see you there! |
...
<a target="_blank" rel="noopener noreferrer" href="https://docs.geti.intel.com/docs/user-guide/learn-geti/computer-vision-tasks/task-chaining-project">Chaining multiple tasks</a> (such as detection and classification) enables Geti™ users to develop a more granular model and collaborate more effectively across teams. This way users can decouple sequential models to break down complex tasks into smaller, more manageable tasks and simultaneously create multiple, specialized models rather than forcing a single model to learn every aspect of the task at hand.
</details>

<details>
<summary>🎯 Model Evaluation </summary>
Geti™ provides users with comprehensive statistics to assess model’s performance and run live tests. Geti™ executes model testing to evaluate the model performance on unseen data to ensure that the model is fit for purpose for the real-life deployment setup.
...
Geti™ outputs optimized deep learning model for the OpenVINO™ toolkit to run on Intel® architecture CPUs, GPUs and VPUs or models in PyTorch* format.
</details>

## 🧮 Supported models

Geti™ supports several neural network architectures, each tailored to specific computer vision tasks. The table below provides an overview of the supported tasks, types, and corresponding model architectures.

### Supported deep learning models

| Computer Vision Task | Feature                                          | Model Architectures Supported                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|----------------------|--------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Object Detection     | Counting <br/>Rotated Object Detection           | [D-Fine](https://arxiv.org/abs/2410.13842) <br/> [YOLOX](https://arxiv.org/abs/2107.08430) <br/>[RT-DETR](https://arxiv.org/abs/2304.08069) <br/> [MobileNetV2](https://arxiv.org/abs/1801.04381)+[ATSS](https://arxiv.org/abs/1912.02424) <br/>[ResNeXt101](https://arxiv.org/pdf/1611.05431)+[ATSS](https://arxiv.org/abs/1912.02424) <br/>[MobileNetV2](https://arxiv.org/abs/1801.04381)+[SSD](https://arxiv.org/abs/1512.02325) <br/>[EfficientNetB2B](https://arxiv.org/abs/1905.11946)+[MaskRCNN](https://arxiv.org/abs/1703.06870) <br/>[ResNet50](https://arxiv.org/abs/1512.03385)+[MaskRCNN](https://arxiv.org/abs/1703.06870) |
...
| Image Segmentation   | Instance Segmentation <br/>Semantic Segmentation | [RTMDet](https://arxiv.org/abs/2212.07784) <br/> [EfficientNetB2B](https://arxiv.org/abs/1905.11946)+[MaskRCNN](https://arxiv.org/abs/1703.06870) <br/>[ResNet50](https://arxiv.org/abs/1512.03385)+[MaskRCNN](https://arxiv.org/abs/1703.06870) <br/>[Swin Transformer](https://arxiv.org/abs/2103.14030)+[MaskRCNN](https://arxiv.org/abs/1703.06870) <br/>[Lite-HRNet](https://arxiv.org/abs/2104.06403) <br/>[SegNext](https://arxiv.org/abs/2209.08575) <br/>[DinoV2](https://arxiv.org/abs/2304.07193)                                                                                                                                  |
...
| Keypoint Detection   | Keypoint and feature detection                   | [RTMPose](https://arxiv.org/abs/2303.07399)                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
Please see the details in [Geti™ documentation](https://docs.geti.intel.com/docs/developer-guide).
...
- [Geti™ SDK](https://github.com/open-edge-platform/geti-sdk) - Software Development Kit (SDK) for the Geti™.
...
- [OpenVINO™ Test Drive](https://github.com/openvinotoolkit/openvino_testdrive) - With OpenVINO Test Drive, users can run large language models (LLMs) and models trained by Geti™ on their devices, including AI PCs and Edge devices.
...
Geti™ repository is licensed under [LIMITED EDGE SOFTWARE DISTRIBUTION LICENSE](LICENSE).

Models fine-tuned by Geti™ are licensed under [Apache License Version 2.0](https://opensource.org/licenses/Apache-2.0).
