...
import { InferenceImageInstance, WatershedInstance } from '@geti/smart-tools';
...
export type MapAlgorithmToInstance = {
    [AlgorithmType.WATERSHED]: WatershedInstance;
    ...
    [AlgorithmType.INFERENCE_IMAGE]: InferenceImageInstance;
