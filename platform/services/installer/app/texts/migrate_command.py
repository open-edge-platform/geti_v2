...
class MigrateCmdTexts:
    ...
    # password_help = "Password (8 - 200 characters, at least one capital letter, lower letter, digit or symbol)"
    ...
    # selected_password = "Password for initial user: "
    ...
    # smtp_password_prompt = "SMTP password"
    ...
    #     "Do you want to install the Grafana stack (
...
class MigrateCmdConfirmationTexts:
    """
