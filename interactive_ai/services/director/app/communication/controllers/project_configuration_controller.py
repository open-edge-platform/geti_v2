...
class ProjectConfigurationRESTController:
    ...
    def get_configuration(
        ...
        # use provided task_id if available, check if project is single task
        if task_id or len(project_config.task_configs) == 1:
            _task_id = task_id or project_config.task_configs[0].task_id
            try:
