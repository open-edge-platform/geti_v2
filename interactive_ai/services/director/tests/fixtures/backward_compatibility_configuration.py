...
from geti_configuration_tools.training_configuration import (
    TrainingConfiguration, GlobalParameters, GlobalDatasetPreparationParameters,
    SubsetSplit, Filtering, MinAnnotationPixels, MaxAnnotationPixels,
    MinAnnotationObjects, MaxAnnotationObjects
)
from geti_configuration_tools.hyperparameters import (
    Hyperparameters, TrainingHyperParameters, EvaluationParameters,
    DatasetPreparationParameters, AugmentationParameters, Tiling,
    EarlyStopping, MaxDetectionPerImage
)
       ...
       "data":{
          ...
          "learning_parameters":{
             ...
             "num_iters":{
                "value":90,
                "default_value":90,
                "description":"Maximum number of epochs to train a model. Increasing this value may result in longer training, but potentially in a more robust model. Note, if the early stopping is enabled, the actual number of epochs may be less than this value.",
       ...
       "data":{
          ...
          "learning_parameters":{
             ...
             "learning_rate_warmup_iters":{
                "value":100,
                "default_value":100,
                "description":"In this periods of initial training iterations, the model will be trained in low learning rate, which will be increased linearly up to the expected learning rate setting. This warm-up phase is known to be helpful to stabilize training, therefore, can lead to increased performance.",
                "header":"Number of iterations for learning rate warmup",
                "warning":None,
                "editable":True,
                "visible_in_ui":True,
             ...
             "input_size":{
                "value":"Auto",
                "default_value":"Auto",
                "description":"The input size of the given model could be configured to one of the predefined resolutions. Reduced training and inference time could be expected by using smaller input size. Defaults to Auto, in which input size is automatically determined based on dataset statistics.",
                "header":"Configure model input size.",
                "warning":"Modifying input size may decrease model performance.",
                "editable":True,
                "visible_in_ui":False,
       ...
       "data":{
          ...
          "learning_parameters":{
             ...
             "max_epochs":{
                ...
                "header":"Max Epochs",
                "warning":"Training for very few epochs might lead to poor performance. If Early Stopping is enabled then increasing the value of max epochs might not lead to desired result.",
                "editable":True,
                "visible_in_ui":True,
                "affects_outcome_of":"TRAINING",
                "ui_rules":{
             ...
             "early_stopping":{
                ...
                "patience":{
                   "value":10,
                   "default_value":10,
                   "description":"Number of epochs to wait for an improvement in the monitored metric. If the metric has not improved for this many epochs, the training will stop and the best model will be returned.",
                   "header":"Early Stopping Patience",
                   "warning":"Setting this value too low might lead to underfitting. Setting the value too high will increase the training time and might lead to overfitting.",
                   "editable":True,
                   "visible_in_ui":True,
                   "affects_outcome_of":"TRAINING",
                   "ui_rules":{
        ...
        # Project dataset management
        {
            "data": {
                ...
                "minimum_annotation_size": {
                    "value": -1,
                    "default_value": -1,
                    "description": "Minimum size of a shape in pixels. Any shape smaller than this will be ignored during         training. Setting this to -1 disables the setting.",
                ...
                "maximum_number_of_annotations": {
                    "value": 500,
                    "default_value": -1,
                    "description": "The maximum number of shapes that can be in an annotation. Any annotations with more shapes than this number will be ignored during training. Setting this to -1 disables the setting.",
        ...
        # Annotation requirements
        {
            "data": {
                ...
                "required_images_auto_training_dynamic": {
                    "value": 12,
                    "default_value": 12,
                    "description": "An optimal minimum number of images required for auto-training, calculated based on model performance and dataset size",
        ...
        # Subset splitting
        {
            "data": {
                ...
                "train_validation_remixing": {
                    "value": False,
                    "default_value": False,
                    "description": "Turn on this setting to reshuffle training and validation subsets every training round. This strategy could improve the performance of the model on the testing subset, especially when there is new data added in between training rounds.",
                ...
                "subset_parameters": {
                    ...
                    "description": "Specify the distributions of annotated samples over training, validation and test set. These values must add up to 1, and will be rescaled if they do not add up correctly.",
                    "visible_in_ui": True,
                    "type": "PARAMETER_GROUP",
                    "train_proportion": {
                        "value": 0.5,
            ...
            dataset_preparation=GlobalDatasetPreparationParameters(
                ...
                filtering=Filtering(
                    min_annotation_pixels=MinAnnotationPixels(
                       enable=True, min_annotation_pixels=10
                    ),
                    ...
                    max_annotation_objects=MaxAnnotationObjects(
                       enable=True, max_annotation_objects=1000
                    )
                )
            )
        ),
