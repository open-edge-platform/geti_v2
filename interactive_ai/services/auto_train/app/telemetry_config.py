...
"""Initialize telemetry (logging, traces, ...)"""
...
def setup_telemetry() -> None:
    """Initialize the logger and the telemetry, if enabled"""
    logger = configure_logger()
    logger.info("Logger has been initialized in the auto-train controller")
