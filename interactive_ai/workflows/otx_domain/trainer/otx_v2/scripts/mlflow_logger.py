...
# ruff: noqa: E501, PLR0913, S101, PLW2901, E731
"""
IMPORTANT NOTE
--------------
This code is copied from https://github.com/Lightning-AI/pytorch-lightning under Apache License, Version 2.0, copyright The Lightning AI team.
It is because OTX 2.1 is currently using `lightning==2.2.0` which has no `synchronous` argument on `MLFlowLogger` class.
We can remove this file and just do `from lightning.pytorch.loggers.mlflow import MLFlowLogger` if we upgrade to `lightning>=2.3.0`.
"""
...
class MLFlowLogger(Logger):
    ...
    def finalize(self, status: str = "success") -> None:
        ...
        try:
            ...
            log.exception("Failed to finalize logger")
